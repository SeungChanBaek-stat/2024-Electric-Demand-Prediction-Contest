...
# train_data에서 'electric_train.num' == 17677 인 행 train_data_17677으로 분리
train_data_17677 = train_data[train_data['electric_train.num'] == 17677]
print(train_data_17677.shape)
print(train_data.shape)
...
# train_data에서 'electric_train.num' == 17677 인 행 train_data으로 분리
train_data = train_data[train_data['electric_train.num'] == 17677]
print(train_data.shape)
print(train_data.shape)
...
train_data.to_csv(os.path.join(data_dir, 'electric_train_preprocessed_17677.csv'), index=False)
# test_data.to_csv(os.path.join(data_dir, 'electric_test_preprocessed_17677.csv'), index=False)
